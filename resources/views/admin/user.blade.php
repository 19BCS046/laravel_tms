...
<body>
            ...
            <div class="mask d-flex align-items-center h-100">
                <div class="container" style="margin-top: 30px;">
                    <div class="navbar px-4 py-3 mb-0">
                        ...
                        <form id="downloadCsvForm" action="{{ route('download.users') }}" method="GET" class="ms-auto">
                            @csrf
                            <button type="button" class="btn btn-primary" id="downloadCsvBtn">Download Csv</button>
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#downloadCsvBtn').click(function (e) {
                e.preventDefault();
                let confirmation = confirm('Are you sure you want to download the CSV file?');
